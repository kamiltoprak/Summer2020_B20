...
public class R047_IfCon_RealEstateCalculator {
        ...
        public static void main(String[] args) {
            ...
            switch (houseType) {
                case "Condo":
                    housePrice = 50000 + bedroomsPrice + backyardPrice + spotsPrice + highwayPrice + schoolScorePrice + smokingPrice + metroPrice ;
                    break;
                case "Townhouse":
                    housePrice = 75000 + bedroomsPrice + backyardPrice + spotsPrice + highwayPrice + schoolScorePrice + smokingPrice + metroPrice ;
                    break;
                case "Single Family Home":
                    housePrice = 95000 + bedroomsPrice + backyardPrice + spotsPrice + highwayPrice + schoolScorePrice + smokingPrice + metroPrice ;
                    break;
