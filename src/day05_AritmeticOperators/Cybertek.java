...
/** A component that displays a flower. */
    public class Cybertek extends JPanel {

        /** Program that displays a flower in a window. */
        public static void main(String[] args) {
            JFrame frame = new JFrame("CyberTek");
            frame.setSize(1000, 200);
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

            JPanel Cybertek = new Cybertek();
            Cybertek.setBackground(Color.blue);
        ...
        public void paintComponent(Graphics g) {
            ...
            g2.drawLine(toScreenX(100), toScreenY(100), toScreenX(100), toScreenY(70));
